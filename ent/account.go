...
func (e AccountEdges) PlayersOrErr() ([]*Player, error) {
	if e.loadedTypes[0] {
...
func (*Account) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case account.FieldEmail, account.FieldPasswordHash, account.FieldSalt, account.FieldStatus:
...
// QueryPlayers queries the "players" edge of the Account entity.
func (_m *Account) QueryPlayers() *PlayerQuery {
	return NewAccountClient(_m.config).QueryPlayers(_m)
}
