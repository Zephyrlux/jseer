...
func (_q *PlayerQuery) QueryAccount() *AccountQuery {
...
func (_q *PlayerQuery) QueryPets() *PetQuery {
...
func (_q *PlayerQuery) QueryItems() *ItemQuery {
...
func (_q *PlayerQuery) WithAccount(opts ...func(*AccountQuery)) *PlayerQuery {
	query := (&AccountClient{config: _q.config}).Query()
...
func (_q *PlayerQuery) WithPets(opts ...func(*PetQuery)) *PlayerQuery {
	query := (&PetClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *PlayerQuery) WithItems(opts ...func(*ItemQuery)) *PlayerQuery {
	query := (&ItemClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *PlayerQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Player, error) {
	...
	if query := _q.withAccount; query != nil {
		if err := _q.loadAccount(ctx, query, nodes, nil,
			func(n *Player, e *Account) { n.Edges.Account = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withPets; query != nil {
		if err := _q.loadPets(ctx, query, nodes,
			func(n *Player) { n.Edges.Pets = []*Pet{} },
			func(n *Player, e *Pet) { n.Edges.Pets = append(n.Edges.Pets, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withItems; query != nil {
		if err := _q.loadItems(ctx, query, nodes,
			func(n *Player) { n.Edges.Items = []*Item{} },
			func(n *Player, e *Item) { n.Edges.Items = append(n.Edges.Items, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *PlayerQuery) loadAccount(ctx context.Context, query *AccountQuery, nodes []*Player, init func(*Player), assign func(*Player, *Account)) error {
...
func (_q *PlayerQuery) loadPets(ctx context.Context, query *PetQuery, nodes []*Player, init func(*Player), assign func(*Player, *Pet)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(pet.FieldPlayerID)
	}
	query.Where(predicate.Pet(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(player.PetsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *PlayerQuery) loadItems(ctx context.Context, query *ItemQuery, nodes []*Player, init func(*Player), assign func(*Player, *Item)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Player)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(item.FieldPlayerID)
	}
	query.Where(predicate.Item(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(player.ItemsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *PlayerQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withAccount != nil {
			_spec.Node.AddColumnOnce(player.FieldAccountID)
		}
	}
