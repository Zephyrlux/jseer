...
func (_q *PetQuery) QueryPlayer() *PlayerQuery {
...
func (_q *PetQuery) WithPlayer(opts ...func(*PlayerQuery)) *PetQuery {
	query := (&PlayerClient{config: _q.config}).Query()
...
func (_q *PetQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Pet, error) {
	...
	if query := _q.withPlayer; query != nil {
		if err := _q.loadPlayer(ctx, query, nodes, nil,
			func(n *Pet, e *Player) { n.Edges.Player = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *PetQuery) loadPlayer(ctx context.Context, query *PlayerQuery, nodes []*Pet, init func(*Pet), assign func(*Pet, *Player)) error {
...
func (_q *PetQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withPlayer != nil {
			_spec.Node.AddColumnOnce(pet.FieldPlayerID)
		}
	}
